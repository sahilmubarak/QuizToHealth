...
function NavigationFunction() 
{
  ...
  var RightAnswers =["Q1A3", "Q2A1","Q3A5","Q4A1","Q5A5","Q6A1","Q7A4","Q8A1","Q9A1","Q10A5"]; 
...
function SelectQ3A4()
{
  ...
  a.checked=true;
  SelectedAnswer[2]="Q3A4";
}
function SelectQ3A5()
{
  var a =document.getElementById("Q3A5");
  a.checked=true;
  SelectedAnswer[2]="Q3A5";
}
...
function SelectQ8A3()
{
  ...
  a.checked=true;
  SelectedAnswer[7]="Q8A3";
}
function SelectQ8A4()
{
  var a =document.getElementById("Q8A4");
  a.checked=true;
  SelectedAnswer[7]="Q8A4";
}
